...
class CslMobileAccountDetailsScreen(AndroidCapabilities):
    ...
    def csl_mobile_account_details(self):
        ...
        mobile_action.type_text(self.csl_mobile_email_xpath, email + result)
        mobile_action.type_text(self.csl_mobile_password_xpath, Readconfig.get_director_password())
        mobile_action.type_text(self.csl_mobile_confirm_password_xpath, Readconfig.get_director_password())
        ...
        time.sleep(2)
        mobile_action.type_text(self.authentication_1_textbox_xpath, "123")
        ...
        time.sleep(2)
        mobile_action.type_text(self.authentication_2_textbox_xpath, "123")
        ...
        time.sleep(2)
        mobile_action.type_text(self.authentication_3_textbox_xpath, "abc")

...
class CslMobilePersonalDetailsScreen(AndroidCapabilities):
    ...
    mobile_number_xpath = '//android.widget.EditText[@text="Mobile Number"]'
    occupation_xpath = '//android.widget.EditText[@text="Occupation"]'
    professional_interest_xpath = '//android.widget.TextView[@text=""]'
    select_transport_xpath = '//android.widget.TextView[@text="Transport"]'
    close_professional_interest_xpath = '(//android.widget.TextView[@resource-id="iconIcon"])[1]'
    address_xpath = '//android.widget.EditText[@text="Address"]'
    town_or_city_xpath = '//android.widget.EditText[@text="Town/City"]'
    province_xpath = '//android.widget.EditText[@text="Province"]'
    postal_code_xpath = '//android.widget.EditText[@text="Postal Code"]'

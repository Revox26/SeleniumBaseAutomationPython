...
class DestinationxCreateAnAccountPage(AndroidCapabilities):
    ...
    password = '//android.widget.EditText[@resource-id="RNE__Input__text-input" and @text="Password"]'
    confirm_password = '//android.widget.EditText[@resource-id="RNE__Input__text-input" and @text="Confirm Password"]'
    ...
    def register_new_account(self):
        ...
        mobile_action.type_text(self.password, Readconfig.get_director_password())
        mobile_action.type_text(self.confirm_password, Readconfig.get_director_password())
